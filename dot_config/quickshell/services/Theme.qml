...
Singleton {
  ...
  readonly property string familyMono: "CaskaydiaCove NFM"
  readonly property font font: Qt.font({
    family: "CaskaydiaCove NF", pointSize: pointSize })
  ...
  readonly property color selectionBg: Qt.rgba(0.576, 0.604, 0.714, 0.2)
}
